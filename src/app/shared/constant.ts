...
export const API_URL = 'http://metricssubmissionapi-metricssubmissionapi.iksopenshiftdev-2face0433451d5f4f63e8f7ab10f8f12-0000.eu-de.containers.appdomain.cloud';
...
export const FIND_ALL_REGION  =  "region/findallregion";
export const FIND_ALL_SUB_GROUP = "subgroup/findallsubgroup";
export const ADD_ONE_SUB_GROUP ="subgroup/addonesubgroup"
